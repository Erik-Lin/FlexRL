...
import numpy as np
import math
import algorithms.ddpg.utils as utils
import algorithms.ddpg.model as model
...
class Agent:
	...
	def save_models(self, model_path):
		# 保存神经网络模型的权重
		torch.save(self.target_actor.state_dict(), model_path+'_actor.pt')
		torch.save(self.target_critic.state_dict(), model_path+'_critic.pt')
